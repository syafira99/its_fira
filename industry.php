...
form {
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          ...
          <ol>
            ...
            <li><a href="industrylist.php">Company List</a></li>
    ...
    <!-- ======= Form ======= -->
    <section id="industryform">
      <div class="container">

        <center><form method="POST" action="registerindustryprocess.php">
      ...
      <br><div class="form-group">
        <label for="comp_contact">Contact</label>
        <input type="text" class="form-control" id="comp_contact" name="comp_contact" required/>
      </div>
